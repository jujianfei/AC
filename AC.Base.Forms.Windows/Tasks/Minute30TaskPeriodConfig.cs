...
{
    /// <summary>
    /// 每30分钟执行一次的自动任务周期配置界面。
    /// </summary>
    [Control(typeof(AC.Base.Tasks.Minute30TaskPeriod))]
    public class Minute30TaskPeriodConfig : Label, ITaskPeriodConfigControl
    {
        private Minute30TaskPeriod m_TaskPeriod;

        /// <summary>
        /// 每30分钟执行一次的自动任务周期配置界面。
        /// </summary>
        public Minute30TaskPeriodConfig()
        {
            this.Text = "每小时00分、30分启动运行，每天运行48次。";
        }
