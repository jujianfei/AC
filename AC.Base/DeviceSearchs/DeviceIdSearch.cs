...
namespace AC.Base.DeviceSearchs
{
    ...
    /// 提供按照设定条件搜索指定设备ID的功能。
    /// </summary>
    public class DeviceIdSearch : Searchs.SearchBase<IList<int>, int, IDeviceFilter, IDeviceOrder>
    {
        ...
        public DeviceIdSearch(ApplicationClass application)
            : base(application)
        {
        ...
        {
            return new Searchs.SearchSelectColumn[] { new Searchs.SearchSelectColumn(Tables.Device.TableName, new string[] { Tables.Device.DeviceId }) };
        }
            ...
            try
            {
                ...
                if (dr != null)
                {
                    while (dr.Read())
                    {
                        ...
                        if (lstId.Contains(intDeviceId) == false)
                        {
                            lstId.Add(intDeviceId);
                        }
                    }
                    dr.Close();
                }
