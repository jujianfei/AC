...
namespace AC.Base.Drives.Electrics
{
    ...
    /// </summary>
    [DriveImplement("召测电流")]
    public interface ICallCurrentDriveImplement : IDriveImplement
    {
        /// <summary>
        /// 召测当前实时电流。如果是单相用电设备则A相数据有效，B、C相属性不使用，否则应根据 allPhase 参数提供三相分相位及零相数据。
        ...
        /// <returns></returns>
        PhaseZeroValue CallCurrent(bool allPhase);
    }
}
