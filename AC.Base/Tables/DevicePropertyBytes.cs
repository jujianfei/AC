...
namespace AC.Base.Tables
{
    ...
    /// 设备二进制数据属性。
    /// </summary>
    [Database.Table("设备二进制数据属性", Database.TableCreateRuleOptions.Only, "")]
    public struct DevicePropertyBytes
    {
        /// <summary>
        /// 数据表名
        /// </summary>
        public const string TableName = "DevicePropertyBytes";
        ...
        /// 二进制数值
        /// </summary>
        [Database.Column("二进制数值", "", Database.DataTypeOptions.File, false, true)]
