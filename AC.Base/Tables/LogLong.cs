...
namespace AC.Base.Tables
{
    ...
    /// 日志长整数属性值。
    /// </summary>
    [Database.Table("日志长整数属性值", Database.TableCreateRuleOptions.Monthly, "")]
    public struct LogLong
    {
        /// <summary>
        /// 数据表名
        /// </summary>
        public const string TableName = "LogLong";
        ...
        /// 属性数值
        /// </summary>
        [Database.Column("属性数值", "", Database.DataTypeOptions.Long, false, false)]
