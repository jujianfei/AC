...
namespace AC.Base.Tables
{
    ...
    /// 日志整数属性值。
    /// </summary>
    [Database.Table("日志整数属性值", Database.TableCreateRuleOptions.Monthly, "")]
    public struct LogInt
    {
        /// <summary>
        /// 数据表名
        /// </summary>
        public const string TableName = "LogInt";
        ...
        /// 属性数值
        /// </summary>
        [Database.Column("属性数值", "", Database.DataTypeOptions.Int, false, false)]
