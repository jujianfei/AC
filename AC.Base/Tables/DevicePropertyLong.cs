...
namespace AC.Base.Tables
{
    ...
    /// 设备长整数属性。
    /// </summary>
    [Database.Table("设备长整数属性", Database.TableCreateRuleOptions.Only, "")]
    public struct DevicePropertyLong
    {
        /// <summary>
        /// 数据表名
        /// </summary>
        public const string TableName = "DevicePropertyLong";
        ...
        /// 长整数数值
        /// </summary>
        [Database.Column("长整数数值", "", Database.DataTypeOptions.Long, false, true)]
