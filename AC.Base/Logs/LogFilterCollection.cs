...
namespace AC.Base.Logs
{
    ...
    /// 日志筛选器集合。
    /// </summary>
    public class LogFilterCollection : System.Collections.Generic.IList<ILogFilter>, ILogFilter
    {
        ...
        public void SetApplication(ApplicationClass application)
        {
            ...
            foreach (ILogFilter filter in this)
            {
            ...
            if (this.Count > 0)
            {
                ...
                else
                {
                    ...
                    foreach (ILogFilter filter in this)
                    {
                        ...
                        {
                            if (filter is LogFilterCollection)
                            {
                                LogFilterCollection f = filter as LogFilterCollection;
                                if (f.Count > 0)
                                {
        ...
        /// <returns></returns>
        public int IndexOf(ILogFilter item)
        {
        ...
        /// <param name="item"></param>
        public void Insert(int index, ILogFilter item)
        {
        ...
        #region ICollection<ILogFilter> 成员
        ...
        public void CopyTo(ILogFilter[] array, int arrayIndex)
        {
        ...
        #region IEnumerable<ILogFilter> 成员
