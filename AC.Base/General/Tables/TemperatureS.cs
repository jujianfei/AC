...
{
    /// <summary>
    /// 温度分秒曲线数据。温度数值：6位整数4位小数；单位：℃。
    /// </summary>
    [Database.Table("温度分秒曲线数据", Database.TableCreateRuleOptions.Monthly, "")]
    public struct TemperatureS
    {
        /// <summary>
        /// 数据表名
        /// </summary>
        public const string TableName = "TemperatureS";
        ...
        /// 数值
        /// </summary>
        [Database.Column("数值", "", 10, 4, false, false)]
