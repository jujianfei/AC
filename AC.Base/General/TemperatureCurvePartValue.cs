...
namespace AMS.Monitoring.General
{
    ...
    /// 日温度曲线段值。
    /// </summary>
    public class TemperatureCurvePartValue : CurvePartValue
    {
        /// <summary>
        /// 日温度曲线段值。
        /// </summary>
        ...
        public TemperatureCurvePartValue(Device device, DateTime date, CurvePointOptions curvePoint, int startTimeNum, int endTimeNum)
        ...
        public TemperatureCurvePartValue(Device device, DateTime date, CurvePointOptions curvePoint, int startTimeNum, decimal?[] values)
        ...
        /// <param name="endTimeNum">最后一个点的数值所对应的时间（hhmmss）。</param>
        /// <param name="values">曲线段各点数据。</param>
        public TemperatureCurvePartValue(Device device, DateTime date, int startTimeNum, int endTimeNum, decimal?[] values)
