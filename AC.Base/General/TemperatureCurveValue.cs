...
namespace AMS.Monitoring.General
{
    ...
    /// 日温度曲线值。
    /// </summary>
    public class TemperatureCurveValue : CurveValue
    {
        /// <summary>
        /// 日温度曲线值。
        /// </summary>
        ...
        public TemperatureCurveValue(Device device, DateTime date, CurvePointOptions curvePoint)
            : base(curvePoint)
        {
        ...
        public TemperatureCurveValue(Device device, DateTime date, decimal?[] values)
            : base(values)
        {
            this.m_Device = device;
            this.m_Date = date;
