...
namespace AC.Base.Tasks
{
    ...
    /// 每30分钟执行一次的自动任务周期。
    /// </summary>
    [TaskPeriodType("每30分钟运行一次")]
    public class Minute30TaskPeriod : TaskPeriod
    {
        ...
        public override void Start()
        {
            ...
            this.m_NextRunTime = CurvePointOptions.Point24.FormatDateTime(DateTime.Now);
            this.NextRunTime();
        }
        ...
        {
            this.m_NextRunTime = this.m_NextRunTime.AddSeconds(CurvePointOptions.Point24.GetTimeSpan());
